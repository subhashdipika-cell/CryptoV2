...
describe("calculateBotPerformance", () => {
  it("aggregates bot-only net realized and unrealized P&L by UTC period", () => {
    ...
    const result = calculateBotPerformance([
      ...
      { trade_id:"month", timestamp:Date.UTC(2026,7,2), label:"CV2-AI-BTC-1", profit_loss:-0.001, fee:0.0001, fee_currency:"BTC", index_price:80000 },
      { trade_id:"old", timestamp:Date.UTC(2026,6,2), label:"CV2-AI-BTC-2", profit_loss:0.002, fee:2, fee_currency:"USDC", index_price:75000 },
