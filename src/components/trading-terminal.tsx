...
export function TradingTerminal(){
 ...
 const content={autobot:<AutobotCockpit/>,dashboard:<PortfolioDashboard onOpenStrategy={()=>setActive("cockpit")}/>,overview:<Overview onOpenOrder={setOrder}/>,markets:<Markets/>,insights:<Intelligence/>,patterns:<PatternScanner/>,options:<OptionsSuite/>,cockpit:<StrategyCockpit/>}[active];
